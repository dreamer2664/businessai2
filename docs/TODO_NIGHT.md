...
- [ ] 1. Fallback contact — Gmail two-way (poll owner mail, obey, reply) + scope upgrade to send — 12%
...
- [ ] 5. Google Docs layouts — native Docs API tables/styles per report type — 8%
...
- [ ] 10. Heartbeat/progress system + docs + full regression battery — 7%
